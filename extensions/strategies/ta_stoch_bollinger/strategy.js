...
module.exports = {
  ...
  getOptions: function () {
    ...
    this.option(
      "stoch_k_buy",
      "K must be below this before buying",
      Number,
      25
    );
          ...
          .then(function (inres) {
            ...
            if (_switch != 0) {
              if (
                ...
                Math.max(s.period.close, s.period.open) >=
                  (upperBound / 100) *
                ...
                Math.min(s.period.close, s.period.open) <=
                  (lowerBound / 100) *
  ...
  onReport: function (s) {
    ...
    if (s.period.bollinger) {
      if (s.period.bollinger.upperBound && s.period.bollinger.lowerBound) {
        ...
        cols.push(
          z(8, n(lowerBound).format("0.0000").substring(0, 7), " ").cyan
        );
        cols.push(
          z(8, n(upperBound).format("0.0000").substring(0, 7), " ").cyan
        );
        cols.push(
