...
module.exports = function (program, conf) {
  program
    ...
    .action(function (selector, cmd) {
      ...
      if (so.buy_max_amt) {
        console.log(
          "--buy_max_amt is deprecated, use --deposit instead!\n".red
        );
      ...
      function printTrade(quit, dump, statsonly = false) {
        var tmp_balance = n(s.balance.currency)
        ...
        if (quit || dump) {
          ...
          if (so.filename !== "none") {
            var out_target;
            var out_target_prefix = so.paper
